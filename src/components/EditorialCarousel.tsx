          ...
          return (
            <Link key={post.id} href={`/posts/${post.slug}`}
              ...
              <div className="absolute bottom-0 left-0 right-0 p-5">
                ...
                <h3 className="text-lg font-light text-white leading-snug mb-3">
                  {post.title}
                </h3>
                <span className="inline-flex items-center gap-2 text-xs tracking-widest uppercase text-white/50 
